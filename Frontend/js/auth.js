...
//     // Simple client-side email format check (quick feedback)
...
//       if (res.ok) {
//         // server created user + sent verification email
//         msgEl.style.color = "green";
//         // show message returned from server (e.g. "Registered — check your inbox")
//         msgEl.textContent = data.message || "Registered. Check your email for verification link.";
//         // optionally redirect to login after short delay

//         // show resend controls so user can request resend if they didn't get it
//   showResendUI(email);
//         setTimeout(() => { window.location = "index.html"; }, 2000);
//       } else {
//         msgEl.style.color = "red";
//         msgEl.textContent = data.error || data.message || "Registration failed";
//       }
//     } catch (err) {
//       msgEl.style.color = "red";
//       msgEl.textContent = "Network error";
